...
## PSK
<img width="1190" height="790" alt="image" src="https://github.com/user-attachments/assets/9c03a1a4-0962-4316-98a6-9181a4a055fb" />

## QPSK
<img width="989" height="590" alt="image" src="https://github.com/user-attachments/assets/081d91e0-03de-4bbc-b1e4-790470b4dc7a" />

# Results
```
PSK and QPSK modulation and demodulation were performed successfully, and the transmitted and received data were identical.
```
